...
class AppFullscreenController: UIViewController {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        let translationY = -100 - UIApplication.shared.statusBarFrame.height
    ...
    private func setupCloseButton() {
        ...
        closeButton.anchor(
            top: view.safeAreaLayoutGuide.topAnchor, leading: nil, bottom: nil, trailing: view.trailingAnchor,
    ...
    private func setupfloatingControls() {
        ...
        floatingContainerView.anchor(top: nil, leading: view.leadingAnchor, bottom: view.bottomAnchor,trailing: view.trailingAnchor,
